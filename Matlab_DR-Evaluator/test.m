function exitcode = kwprediction(lighting,thermostat,chiller)
%{
...
lighting = str2double (lighting);
thermostat = str2double (thermostat);
chiller = str2double (chiller);

forecast(34)=lighting;
forecast(32)=thermostat;
forecast(33)=chiller;

predictedkW = predict(Rforest.Rforest,forecast);
